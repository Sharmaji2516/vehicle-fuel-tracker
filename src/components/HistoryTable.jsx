                    ...
                    <tbody className="divide-y divide-slate-700">
                        {entries.map((entry) => (
                            <tr key={entry.id} className="hover:bg-slate-700/30 transition-colors border-b border-slate-700 last:border-0">
                                ...
                                <td className="px-6 py-4">{entry.liters} L</td>
            ...
            <div className="md:hidden space-y-4">
                ...
                {entries.map((entry) => (
                    <div key={entry.id} className="bg-slate-800 p-4 rounded-xl border border-slate-700 shadow-lg flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm text-slate-400 border-t border-slate-700/50 pt-3">
                            <div>Fuel: <span className="text-slate-200">{entry.liters} L</span></div>
                            <div>Price: <span className="text-slate-200">₹{entry.price}/L</span></div>
                        </div>
