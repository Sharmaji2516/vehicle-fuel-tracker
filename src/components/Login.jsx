    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-950">
            ...
            <div id="recaptcha-container"></div>
             ...
             >
                 <div className="bg-white/95 backdrop-blur-xl p-8 rounded-3xl border border-slate-200 shadow-2xl relative overflow-hidden">
                     {/* Decorative Top Border */}
                     <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500" />
 
                     <div className="mb-8 text-center flex flex-col items-center">
                         {/* Chittor Tech Logo & Branding */}
                         <motion.div
                         ...
                         >
                             <span className="text-[10px] uppercase tracking-[0.25em] text-indigo-600 font-extrabold bg-indigo-50 py-1.5 px-4 rounded-full border border-indigo-100 mb-3">
                                 A Product of Chittortech
                             </span>
                             <img 
                                 src="/chittortech_logo.png" 
                         ...
                         <motion.h1
                             ...
                             className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-cyan-500 mb-1 tracking-tight"
                         >
                             FuelTracker
                         </motion.h1>
                         ...
                         >
                                 <form onSubmit={handleSubmit} className="space-y-5">
                                             ...
                                             >
                                                 <div className="relative group">
                                                     ...
                                                     <input
                                                         ...
                                                         className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-12 pr-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition-all duration-200 font-semibold"
                                                     />
                                                 </div>
                                             </motion.div>
                                         )}
                                     ...
                                     {error && (
                                         <motion.div
                                             ...
                                             className="bg-red-50 border border-red-200 text-red-600 text-xs p-3.5 rounded-xl flex items-center gap-2 font-medium"
                                         >
                                 ...
                                 <div className="space-y-3">
                                     <motion.button
                                         ...
                                         whileTap={{ scale: 0.98 }}
                                         onClick={login}
                                         className="w-full flex items-center justify-center gap-3 bg-white text-slate-700 border border-slate-200 font-bold py-3.5 px-4 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm hover:shadow-md"
                                     >
                                     ...
                                     <div className="text-center mt-4">
                                         ...
                                         >
                                             ...
                                             <span className="text-indigo-600 hover:underline font-semibold">{isSignUp ? 'Sign In' : 'Sign Up'}</span>
                                         </button>
                                     </div>
                                 </div>
                             </motion.div>
